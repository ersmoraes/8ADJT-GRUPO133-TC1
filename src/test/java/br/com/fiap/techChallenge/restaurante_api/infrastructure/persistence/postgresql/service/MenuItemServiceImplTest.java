...
class MenuItemServiceImplTest {
    ...
    void shouldFindByName() {
        ...
        MenuItem menuItem =  MenuItem.create(id, "Pizza", "Deliciosa", BigDecimal.TEN, false, "url");
        MenuItemDTO menuItemDTO =
                new MenuItemDTO(menuItem.getId(), menuItem.getName(), menuItem.getDescription(), menuItem.getPrice(),menuItem.isOnlyLocal() ,menuItem.getUrlFoto());
        when(menuItemRepository.findByName("Pizza")).thenReturn(menuItemDTO);
